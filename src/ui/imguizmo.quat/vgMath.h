...
#define M(X, Y) (m##X * m.m##Y)
  Mat3 operator*(const Mat3& m) const {
    return {
        M(00, 00) + M(10, 01) + M(20, 02), M(01, 00) + M(11, 01) + M(21, 02),
...
TEMPLATE_TYPENAME_T class Mat4 {
 public:
  union {
    VEC4_T v[4];
    struct {
      T m00, m01, m02, m03, m10, m11, m12, m13, m20, m21, m22, m23, m30, m31,
          m32, m33;
    };
  };
  ...
  Mat4() = default;
  explicit Mat4(T s)
      : v{VEC4_T(s, 0, 0, 0), VEC4_T(0, s, 0, 0), VEC4_T(0, 0, s, 0),
          VEC4_T(0, 0, 0, s)} {}
  Mat4(const VEC4_T& v0, const VEC4_T& v1, const VEC4_T& v2, const VEC4_T& v3)
      : v{v0, v1, v2, v3} {}
  Mat4(const MAT3_T& m)
      : v{VEC4_T(m.v[0], 0), VEC4_T(m.v[1], 0), VEC4_T(m.v[2], 0),
          VEC4_T(0, 0, 0, 1)} {}
  Mat4(T v0x, T v0y, T v0z, T v0w, T v1x, T v1y, T v1z, T v1w, T v2x, T v2y,
       T v2z, T v2w, T v3x, T v3y, T v3z, T v3w)
      : v{VEC4_T(v0x, v0y, v0z, v0w), VEC4_T(v1x, v1y, v1z, v1w),
          VEC4_T(v2x, v2y, v2z, v2w), VEC4_T(v3x, v3y, v3z, v3w)} {}
...
TEMPLATE_TYPENAME_T inline MAT3_T mat3_cast(QUAT_T const& q) {
  ...
  return {T(1) - T(2) * (yy + zz), T(2) * (xy + wz),
          T(2) * (xz - wy),        T(2) * (xy - wz),
          T(1) - T(2) * (xx + zz), T(2) * (yz + wx),
          T(2) * (xz + wy),        T(2) * (yz - wx),
          T(1) - T(2) * (xx + yy)};
}
...
TEMPLATE_TYPENAME_T inline VEC2_T mix(const VEC2_T& x, const VEC2_T& y,
                                      const T a) {
  return x + (y - x) * a;
}
TEMPLATE_TYPENAME_T inline VEC3_T mix(const VEC3_T& x, const VEC3_T& y,
                                      const T a) {
  return x + (y - x) * a;
}
TEMPLATE_TYPENAME_T inline VEC4_T mix(const VEC4_T& x, const VEC4_T& y,
                                      const T a) {
  return x + (y - x) * a;
}
// pow
...
TEMPLATE_TYPENAME_T inline MAT3_T inverse(MAT3_T const& m) {
  T invDet = T(1) / (m.m00 * (M(11, 22) - M(21, 12)) -
                     m.m10 * (M(01, 22) - M(21, 02)) +
                     m.m20 * (M(01, 12) - M(11, 02)));
  return MAT3_T((M(11, 22) - M(21, 12)), -(M(01, 22) - M(21, 02)),
                (M(01, 12) - M(11, 02)), -(M(10, 22) - M(20, 12)),
                (M(00, 22) - M(20, 02)), -(M(00, 12) - M(10, 02)),
                (M(10, 21) - M(20, 11)), -(M(00, 21) - M(20, 01)),
                (M(00, 11) - M(10, 01))) *
         invDet;
}  // ==> "operator *" is faster
...
// lookAt
//////////////////////////
TEMPLATE_TYPENAME_T inline MAT4_T lookAt(const VEC3_T& pov, const VEC3_T& tgt,
                                         const VEC3_T& up) {
